...
class Conta:
    ...
    def __init__(self: object, cliente: Cliente) -> None:
        ...
        self.__saldo_total: float = self.calcula_saldo
        Conta.codigo = +1
    ...
    @property
    def calcula_saldo(self: object) -> float:
        return self.saldo + self.limite
    
    def depositar(self: object, valor: float) -> None:
        if valor > 0:
            self.saldo = self.saldo + valor
            self.saldo_total = self.calcula_saldo
            print('Depósito efetuado com sucesso.')
        else:
            print('Nã foi possível efetuar o depósito. Informe um valor válido.')
    ...
    def sacar(self: object, valor:float) -> None:
        if valor > 0 and self.saldo_total >= valor:
            ...
            print('Saque não realizado. Verifique e tente novamente.')
    ...
    def transferir(self: object, destino: object, valor:float) -> None:
        if valor > 0 and self.saldo_total >= valor:
            if self.saldo >= valor:
                ...
                destino.saldo_total = destino.calcula_saldo
            else:
                restante: float = self.saldo - valor
                self.saldo =0
                self.limite = self.limite + restante
            ...
            print("Transferência não realizada. Verifique e tente novamente.")
